...
// name: the other user's display name
// onQuickMessage: function to call with a preset text string when quick-send clicked
const NoChatHistoryPlaceholder = ({ name, onQuickMessage }) => {
  return (
    <div className="flex flex-col items-center justify-center h-full text-center p-6">
      ...
      {/* Greeting heading with the other user's name */}
      ...
      {/* Quick-send buttons — click one to instantly send a preset message */}
      {/* onQuickMessage?.() uses optional chaining so it works even if not provided */}
